...
// The call stack
// inline functions eliminate function overhead of calling a function
// most compilers are good enough now to execute short functions as inline without explicitly telling it to do so
